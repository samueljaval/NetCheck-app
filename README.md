...
4. :warning: **IMPORTANT** :warning: : Check the command line after starting the program to see if there is an SLL certificate error. If so, some text will be printed to the command line to explain what to do. 
